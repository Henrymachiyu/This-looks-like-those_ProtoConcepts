...
def local_analysis(imgs, ppnet_multi,protoc_info, save_analysis_path,test_image_dir,
    ...
    logits, _ = ppnet_multi(images_test,get_act=False, vis_cap=False)
    prototype_activations, _ = ppnet_multi(images_test,get_act=True, vis_cap=False)
    big_proto_act_capped, _ = ppnet_multi(images_test,get_act=False, vis_cap=True)
...
def analyze(opt: Optional[List[str]]) -> None:
    ...
    save_analysis_path = args.save_analysis_dir#os.path.join(test_image_dir, model_base_architecture,
    ...
    bb_tr = os.path.join(load_img_dir,'bbci.pkl') # 'bb29ci.pkl'
    f = open(bb_tr, 'rb')
    ...
    if check_test_accu:
        # test set
        from settings import test_batch_size
    ...
    ##################
    # some examples 
    check_list = ["147.Least_Tern/Least_Tern_0041_153470.jpg",
     "165.Chestnut_sided_Warbler/Chestnut_Sided_Warbler_0008_164001.jpg",
     "146.Forsters_Tern/Forsters_Tern_0064_152047.jpg",
     "002.Laysan_Albatross/Laysan_Albatross_0102_611.jpg",
     "142.Black_Tern/Black_Tern_0104_144038.jpg"]
